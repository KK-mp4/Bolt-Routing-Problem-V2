...
[Star graph](<https://en.wikipedia.org/wiki/Star_(graph_theory)>) is a type of [tree graph](<https://en.wikipedia.org/wiki/Tree_(graph_theory)>) with one internal node and _k_ leaves. You can place the internal node at any arbitrary location, however median or average coordinates of all stations work the best.
