...
function prune(points: Station[], terminalCount: number): { points: Station[]; mst: MstResult } {
...
function buildNetwork(terminals: Station[], points: Station[], edges: [number, number][]): Network {
